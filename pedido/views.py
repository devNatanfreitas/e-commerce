...
class DispatchLoginRequiredMix(View):
...
class Pagar(DispatchLoginRequiredMix,DetailView ):
...
class Detalhe(DispatchLoginRequiredMix, DetailView):   
...
class Lista(DispatchLoginRequiredMix, ListView):
